...
description: Returning field errors from the submit callback and rendering form-level failures.
---

import ServerErrorDemo from '../../../components/ServerErrorDemo.tsx';
...
<ServerErrorDemo client:visible />
