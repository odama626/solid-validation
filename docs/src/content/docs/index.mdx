...
description: Form validation for Solid.js that builds on the browser's own constraint validation.
template: splash
hero:
  tagline: The browser already knows this field is invalid. This library puts that in a store you can render.
  actions:
    - text: Quick start
      link: /solid-validation/quick-start/
      icon: right-arrow
      variant: primary
    - text: Source
