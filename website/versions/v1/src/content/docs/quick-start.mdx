---
title: Quick start
description: Install the package and build a working validated form, start to finish.
---
...
Server errors, async checks, and fields outside a form are all in the guides. If `use:validate` reports a type error or seems to do nothing, see [Troubleshooting](/solid-validation/v1/troubleshooting/).
