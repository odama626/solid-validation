...
description: Validating arbitrary elements with data-name and triggering checks with submit().
---

import OutsideFormDemo from '../../../components/OutsideFormDemo.tsx';
...
<OutsideFormDemo client:visible />
